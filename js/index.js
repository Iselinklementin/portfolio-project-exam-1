...
function latestPosts(urlResponse, media) {
  ...
  sliderTwo.innerHTML += `<img src="${galleryPosts[1].acf.heading_img.url}" alt="Colouring leather" class="slider-img">
                            <p class="gallery-text">${galleryPosts[1].acf.sub_heading}</p>`;

  sliderTwo.href = `detail.html?id=${galleryPosts[1].id}`;

  sliderThree.innerHTML += `<img src="${galleryPosts[0].acf.heading_img.url}" alt="Japan statues" class="slider-img">
